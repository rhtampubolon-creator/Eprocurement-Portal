...
(function loadProcurementFolderRules(){
  ...
  window.addEventListener('DOMContentLoaded',function(){
    ...
    const rules=document.createElement('script');rules.src=new URL('../../procurement-folder-rules.js',window.location.href).href+'?v=20260815-pr-folder-v3';rules.defer=true;rules.dataset.mswPrFolderRules='true';
    rules.addEventListener('load',function(){
      const localFiles=document.createElement('script');localFiles.src=new URL('../../procurement-local-files.js',window.location.href).href+'?v=20260815-pr-local-v3';localFiles.defer=true;localFiles.dataset.mswPrLocalFiles='true';
      localFiles.addEventListener('load',function(){const existingPr=document.createElement('script');existingPr.src=new URL('../../procurement-existing-pr-folder.js',window.location.href).href+'?v=20260815-existing-pr-v3';existingPr.defer=true;existingPr.dataset.mswExistingPrFolder='true';document.body.appendChild(existingPr);},{once:true});
