  ...
  document.body.innerHTML = `
    ...
    async function handleDelete(i){
      ...
      try {
        ...
        // Backend verifies ownership before the local table/cache changes.
    ...
    function buildSmartImportPreview(mappedRows) {
      ...
      mappedRows.forEach((row, index) => {
        ...
        // A deterministic key is required. Missing keys must not become new
        // duplicate records on every import/retry.
        if (!key) {
          row.prYear = "";
